...
dat <- read.csv("D:/UofA/W2/Files for Workshop/exercise1.csv")
...
dat <- read.csv("D:/UofA/W2/Files for Workshop/exercise2.csv")
...
setwd("D:/UofA/W2")
dat <- read.csv("D:/UofA/W2/Files for Workshop/example3.csv")
...
setwd("D:/UofA/W2/Workbook")
dat <- read.csv("D:/UofA/W2/Files for Workshop/exercise3.csv")
...
setwd("D:/UofA/W2/Workbook")
dat <- read.csv("D:/UofA/W2/Files for Workshop/exercise4.csv")
dat$Block <- factor(dat$Block)
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Variety", sig = 0.95)
pred.out
...
dat <- read.csv("D:/UofA/W2/Files for Workshop/example4.csv")
str(dat)
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "trt", sig = 0.95)
pred.out
...
dat.asr <- asreml(Yield ~ Variety, residual =  ~ id(Plot), data = dat)            # fitting the model
dat.ww <- wald(dat.asr, denDF = "default")$Wald
...
dat.reduced <- asreml(EarInfect ~ Treatment, random =~ col, residual =  ~ id(plots), data = dat)
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Genotype", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Fungicide", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Nitrogen", sig = 0.95)
pred.out
 
# graph the predicted values 
...
dat <- read.csv("D:/UofA/W2/Workbook/example6.csv")
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Treatment", sig = 0.95)
pred.out
...
ggsave("Exercise15Variogram.png")
...
pred.out <- tuk.out(pred.obj = dat.pred, model.obj = dat.asr, pred = "Genotype", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Control", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Herbicide", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Herbicide:Rate", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Season", sig = 0.95)
pred.out
...
pred.out <- tuk.out(pred.obj = dat.pred, pred = "Rate", sig = 0.95)
pred.out
